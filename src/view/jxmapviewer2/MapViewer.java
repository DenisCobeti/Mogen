...
public class MapViewer extends JFrame{
    ...
    public MapViewer() {
        ...
        label.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt){
                System.out.println(sa.getGeoCoordinates(mapViewer)[0].toString());
            }
        });
    ...
    public static void main(String[] args)
    {
        ...
        frame.add(new JLabel(USE_INSTRUCTIONS), BorderLayout.NORTH);
        ...
        label.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt){
                System.out.println(sa.getGeoCoordinates(mapViewer)[0].toString());
                System.out.println(sa.getGeoCoordinates(mapViewer)[1].toString());
            }
        });
        label.addMouseListener(sa);
        mapViewer.add(label);
